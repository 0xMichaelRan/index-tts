...
def main():
    ...
    parser.add_argument("-c", "--config", type=str, default="checkpoints_v15/config.yaml", help="Path to the config file. Default is 'checkpoints_v15/config.yaml'")
    parser.add_argument("--model_dir", type=str, default="checkpoints_v15", help="Path to the model directory. Default is 'checkpoints_v15'")
